...
export class MainPage extends FormPage {
    ...
    getWhyTelnyxBtn = () =>
        cy.get('button[id="radix-:R256jm:"]', { timeout: 6000 });
    getPartnersLink = () =>
        cy.get('div>a[href="/partnerships"]', { timeout: 6000 });
    getGlobalCoverageBtn = () =>
        cy.get('a:contains("Explore global coverage")');
